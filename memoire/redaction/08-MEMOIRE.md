...
Consignes pour toute IA qui reprend ce projet (voir aussi ../archives/AI_RULES.md, section 12) :
...
- `../archives/../archives/AI_RULES.md` — règles de développement permanentes du projet
