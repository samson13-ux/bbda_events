...
| `AI_RULES.md` | Contraintes permanentes imposées à tout assistant IA travaillant sur le code |
...
- `AI_RULES.md` et `docs/ARCHITECTURE.md` imposent explicitement **Flask +
...
`README.md`/`AI_RULES.md` déplacés à la racine du projet (convention standard),
